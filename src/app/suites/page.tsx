...
const ROOMS: Room[] = [
  {
    ...
    amenities: ["Free Wi-Fi", "Air Conditioning", "En-suite Bathroom", "Work Desk", "Daily Housekeeping"],
    badge: "Classic",
  ...
  },
  {
    ...
    name: "Executive Room",
    type: "executive",
    description: "Business-ready — quiet, bright, workstation and premium WiFi, perfect for corporate stays.",
    price: 25000,
    image: "/images/suite-garden.jpg",
    images: ["/images/suite-garden.jpg", "/images/suite-executive.jpg"],
    amenities: ["Free Wi-Fi", "Work Desk", "Air Conditioning", "Rain Shower", "Mini Bar", "Daily Housekeeping"],
    badge: "Business",
    href: "/suites/standard",
  },
  {
    ...
    amenities: ["Free Wi-Fi", "Garden Access", "Tea Station", "Walk-in Closet", "King Bed", "Daily Housekeeping"],
    badge: "Royal",
    href: "/suites/standard",
  },
  {
    ...
    type: "presidential",
    description: "Apartment-style living — curated art, living & dining, kitchenette and garden terrace.",
    price: 35000,
    image: "/images/suite-penthouse.jpg",
    images: ["/images/suite-penthouse.jpg", "/images/venue-pavilion.jpg"],
    amenities: ["Free Wi-Fi", "Living & Dining", "Kitchenette", "Garden Terrace", "Workstation", "Daily Housekeeping"],
    badge: "Apartment",
  ...
  },
  {
    ...
    amenities: ["Free Wi-Fi", "Forest Views", "Premium Minibar", "Rain Shower", "Work Desk", "Lounge Access"],
    badge: "Most Popular",
    href: "/suites/presidential",
  },
  {
    ...
    amenities: ["Free Wi-Fi", "Panoramic Views", "Butler Service", "Jacuzzi & Rain Shower", "Private Terrace", "Daily Housekeeping"],
    badge: "Flagship",
    href: "/suites/presidential",
  },
]
    ...
    <>
      ...
      <section className="relative h-[60vh] min-h-[420px] flex flex-col items-center justify-center text-center overflow-hidden bg-secondary" aria-label="Rooms and Suites at Kelmi Lodge">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 px-4">
          <span className="text-xs font-semibold tracking-[0.28em] uppercase text-primary mb-3 block">Kelmi Lodge & Event Center • kelmilodgeandeventhall.com</span>
